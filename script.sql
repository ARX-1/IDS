...
create table CUSTOMER (
    ...
    registration_date int, --DDMMYYYY, DATE typ ?
    user_status boolean,
    --TODO: password
...
create table ORDER(
    ...
    order_state boolean, --true if paid, false otherwise
...
create table PAYMENT(
    ...
    order_state boolean --true if paid, false otherwise, same as ORDER, duplicity..?

    --restrictions:
    CONSTRAINT PK_ID_payment_check primary key (ID_payment),

    --foreign keys:
    CONSTRAINT FK_ID_payment_order_check foergin key (ID_order) regerences ORDER(ID_order)
);
