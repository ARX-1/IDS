...
-- Tento soubor spousti prvni clen tymu pod uctem xuchytj00.
-- Obsahuje: tabulky, sekvence, triggery, sample data, pokrocile
--           objekty 4. casti, indexy, GRANT prava pro xbadiks00.
-- ============================================================
